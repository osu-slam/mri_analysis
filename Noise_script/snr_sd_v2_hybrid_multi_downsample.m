function snr_sd_v2_hybrid_multi_downsample(subjs, runs, prefix)
...
for s = 1:numsubjs % For each subject...
    ...
    functional_dir = [subj_dir f 'FUNCTIONAL_DOWNSAMPLE_' upper(prefix)];    % Specific dir for functional data per subject
...
%         end
        ...
        unix(['mkdir ' snr_dir]);
        snr_bold_dir = [snr_dir f bold '_DOWNSAMPLE'];
