...
% 02/29/20  Updated for new version of experiment. 

function onsets = extract_timing_nowrong_v2(subj, study)
...
scan.order  = 0:scan.epis:scan.epis*(events.all+1)-5; % dropped 5
...
%% Save
cd(dir_subj)
save('onsets_nowrong_v2.mat', 'onsets', 'accuracy')
