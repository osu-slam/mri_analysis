...
% 02/24/20  Forked for v2, which does not include five dummy scans. 
% 02/25/20  Now has all onset types. 

function extract_timing_MVPA_v2(subj, study)
%% Check input
...
scan.order  = 0:scan.epis:(scan.epis*(events.all+1))-5; 
...
%% Save
filename = fullfile(dir_subj, 'onsets_MVPA_v2.mat'); 
